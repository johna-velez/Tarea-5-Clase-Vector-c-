...
class Vector{
    ...
    void SetPos(int i, int n){if(i<=3){v[i]=n;};if(i>3){};} //nos cambia el valor de i-esimo por n
    ...
    int GetSize(){if(tv!=4){return 0;};
    		if(tv==4){return tv;};return 0;}              
    int tam(){return tv;} //tamaño del vector
    
    // sobrecarga operador +
    
    Vector operator+(Vector& u){
        if(tv!=4 or u.tam()!=4){cout<<"uno de los vectores no tiene la longitud adecuada"<<endl; return 0;}
    ...
    int& operator[](int n){
                             ...
                             //return 0;}
                             return v[n];}//solo retorna el valor de la coordenada
